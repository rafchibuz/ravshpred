...
func testDatabase(t *testing.T) *Store {
	...
	for _, sql := range []string{string(base), newsSchema, portalSchema, moviesSchema, submissionKindsSchema, twitchCacheSchema, unbanAppealsSchema, viewerRatingSchema, ratingSnapshotsSchema, ratingAvatarsSchema} {
